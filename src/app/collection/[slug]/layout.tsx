...
import { CollectionTabs } from "@/features/galleries/components/collection-tabs";
...
export default function CollectionLayout({ children }: { children: React.ReactNode }) {
	return (
		<div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
			...
			<div className="mb-8">
				<h1 className="text-3xl font-semibold tracking-tight text-white">Photographers</h1>
			</div>
